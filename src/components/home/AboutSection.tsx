...
const AboutSection = () => (
  <section className="py-16 bg-secondary/30">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <p className="text-sm font-semibold tracking-widest uppercase text-primary text-center">About VBB Store</p>
      ...
      <div className="max-w-3xl mx-auto mt-8 space-y-4 text-muted-foreground text-center">
        ...
        <p className="text-sm">VBB STORE, Madergonj, Pirgonj, Rangpur, Bangladesh - 5470</p>
      </div>

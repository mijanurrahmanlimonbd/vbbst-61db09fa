...
const AboutSection = () => (
  <section className="py-16 bg-secondary/30">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <p className="text-sm font-semibold tracking-widest uppercase text-primary text-center">About Verified BM services</p>
      ...
      <div className="max-w-3xl mx-auto mt-8 space-y-4 text-muted-foreground text-center">
        <p>Verified BM services started with a simple idea: advertisers need reliable, verified accounts without the hassle. We sell verified Facebook Business Managers, WhatsApp Business API accounts, Facebook Ads accounts, TikTok Ads, Google Ads, and reinstated profiles.</p>
        ...
        <p className="text-sm">Verified BM services, Madergonj, Pirgonj, Rangpur, Bangladesh - 5470</p>
      </div>

...
const faqs = [
  ...
  { q: "How do I reach support after purchasing?", a: "Our support team is available 24/7 via WhatsApp (+880 1302 669333), Telegram (@Verifiedbmbuy), and email (info@verifiedbmservices.com). We typically respond within minutes." },

...
const reasons = [
  { icon: <Clock className="w-6 h-6 text-primary" />, title: "5+ Years in Business", desc: "We've been doing this for years. Our track record speaks for itself." },
  { icon: <FileText className="w-6 h-6 text-primary" />, title: "Real Documentation", desc: "Every account comes with genuine docs — no shortcuts, no fakes." },
  ...
  { icon: <Zap className="w-6 h-6 text-primary" />, title: "Same-Day Delivery", desc: "Once payment clears, you get your credentials within minutes. Not hours, not days." },
  { icon: <Shield className="w-6 h-6 text-primary" />, title: "7-Day Guarantee", desc: "Account stopped working? We'll replace it free within 7 days. No questions." },

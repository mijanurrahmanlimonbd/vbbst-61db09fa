...
const stats = [
  { icon: <TrendingUp className="w-6 h-6 text-primary" />, value: "10x Scaling", desc: "Multiply your ad budget capacity" },
  { icon: <DollarSign className="w-6 h-6 text-primary" />, value: "Lower CPMs", desc: "Better delivery with higher trust" },
  { icon: <Users className="w-6 h-6 text-primary" />, value: "Multi-Client", desc: "Manage multiple brands at once" },
  { icon: <Infinity className="w-6 h-6 text-primary" />, value: "No Spend Cap", desc: "Remove daily spending limits" },
];

const ScaleUpCTA = () => (
  <section className="py-16 bg-secondary/30">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <p className="text-sm font-semibold tracking-widest uppercase text-primary text-center">Scale Up</p>
      ...
      <div className="text-center mt-8">
        <Link to="/shop" className="inline-flex items-center px-8 py-3 rounded-lg bg-primary text-primary-foreground font-medium hover:opacity-90 transition-opacity">
          Browse Products
        </Link>
      </div>

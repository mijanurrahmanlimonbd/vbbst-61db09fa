...
import { Bell, ShoppingCart, Users, HeadphonesIcon, CheckCheck, AlertTriangle, Shield, Globe, UserPlus } from "lucide-react";
                ...
                notifications.map((notif) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-start gap-3 w-full text-left px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-0",

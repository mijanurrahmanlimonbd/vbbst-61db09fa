    ...
    >
      ...
      <Link to={`/product/${product.slug}`} className="block relative">
        ...
        <div className="aspect-square bg-secondary overflow-hidden">
          {product.image_url ? (
            <img src={product.image_url} alt={product.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" loading="lazy" width={400} height={400} decoding="async" />
          ) : (
      ...
      <div className="p-5 flex flex-col flex-1 justify-between">
        ...
        {/* Price Box */}
        <div className="mt-4 rounded-lg border border-border bg-[hsl(0,60%,97%)] p-3 min-h-[96px] flex flex-col justify-center">
          {product.sale_price ? (
            <div>

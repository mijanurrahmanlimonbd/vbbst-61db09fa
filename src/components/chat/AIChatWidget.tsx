          ...
          <div className="border-b border-border bg-primary rounded-t-2xl">
            <div className="flex items-center justify-between px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="text-sm font-semibold text-primary-foreground">Verified BM service</span>
              ...
              <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-3">
                {messages.length === 0 && (
                  <div className="text-center py-8 space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">Hello! Welcome to Verified BM service. How can I help you today?</p>
